...
export const PROTOCOL_COMMANDS = {
  ...
  resetTaskBrief: "resetTaskBrief",
  reopenTask: "reopenTask",
  recordOwnerVerification: "recordOwnerVerification",
  acceptTaskCompletionGaps: "acceptTaskCompletionGaps",
  ...
  updateApprovalModeSettings: "updateApprovalModeSettings",
  resolveApprovalRequest: "resolveApprovalRequest",
  authorizeApprovalRetry: "authorizeApprovalRetry",
  revokeApprovalGrant: "revokeApprovalGrant",
  migrateLegacyPermissionSettings: "migrateLegacyPermissionSettings",
  listApprovalDecisionHistory: "listApprovalDecisionHistory",
