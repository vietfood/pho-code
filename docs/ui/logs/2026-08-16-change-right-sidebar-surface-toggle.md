...
When adding a Terminal surface, do not restore a dedicated Collapse icon. Re-click of the active surface (including Terminal once it exists) should hide the panel. Keep exhaustive `RightSidebarSurface` handling.
