...
The v1 critical path ends here. Further MCP-backed capabilities, additional baked skills/extensions, session archive/delete UI, Linux/public distribution, signing/notarization, isolation, and other production work belong to the active [next-version roadmap](../../../version/roadmap-vnext.md). They are not incomplete v1 milestones.
