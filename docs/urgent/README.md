...
- Agent `bash` OS box → [`features/sandbox`](../features/sandbox/README.md)
...
| Agent-tool sandbox | Owner-approved plan; not started | [`features/sandbox`](../features/sandbox/README.md) |
