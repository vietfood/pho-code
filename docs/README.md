...
Pho Code V1 `0.1.0` is an independently owned Rust harness with one DeepSeek API backend, a stable `pho` command surface, and a native four-region GPUI workbench over the same runtime. It owns API-key custody, direct streamed transport, context and tool continuation, first-party tools, approvals, sessions, recovery, and presentation projection. [ADR 0003](decisions/0003-deepseek-api-first-backend.md) records the backend/runtime boundary, [ADR 0004](decisions/0004-native-workbench-phase-6.md) records the expanded native surface, [ADR 0005](decisions/0005-release-v1-and-defer-phase-6b.md) records the first-release and deferred Phase 6B boundary, and [ADR 0006](decisions/0006-chat-first-native-workbench.md) accepts a bounded chat-first presentation before Phase 6B qualifies the integrated surface.
...
| --- | --- | --- |
| Product scope, DeepSeek pivot, command boundary, rationale, alternatives, reversal conditions | [ADR 0003](decisions/0003-deepseek-api-first-backend.md) | Accepted; GPUI surface amended by ADR 0004 |
| Native four-region workbench scope, retained V1 execution limits, read-only viewer, PTY and rendering boundary | [ADR 0004](decisions/0004-native-workbench-phase-6.md) | Accepted decision snapshot; presentation amended by ADR 0006 |
| V1 release boundary and preserved native qualification remainder | [ADR 0005](decisions/0005-release-v1-and-defer-phase-6b.md) | Accepted; V1 `0.1.0` released and Phase 6B ready |
| Chat-first default, tool/reasoning disclosure, pane visibility, terminal reveal, visual hierarchy | [ADR 0006](decisions/0006-chat-first-native-workbench.md) | Accepted; Phase 6C ready, with final qualification owned by Phase 6B |
| Components, dependency direction, identities, instruction profile/context inspection, state, event flow, command/GPUI/runtime boundary | [Native harness system](architecture/native-harness-system.md) | Normative V1 architecture |
| Four-region shell, native presentation projections, Markdown/LaTeX, activity, composer, and workbench-service boundaries | [GPUI workbench](architecture/gpui-workbench.md) | Normative native architecture; chat-first amendment planned for Phase 6C |
| Native entry/startup/shutdown, preferences, layout, focus, accessibility, theme/assets | [Native workbench lifecycle](architecture/native-workbench-lifecycle.md) | Normative native architecture; Phase 6C presentation then integrated Phase 6B qualification |
| Registered workspaces/sessions, atomic switching, file tree/viewer, Git/diff | [Workbench workspaces and inspection](architecture/workbench-workspaces.md) | Normative V1 architecture; released in 0.1.0 |
| User PTY/emulator actor, process/input/output/resize/privacy/shutdown | [User terminal](architecture/user-terminal.md) | Normative native architecture; multi-tab Phase 6B work and lazy reveal Phase 6C amendment |
| API key, Keychain, Chat Completions, SSE, assistant phases, reasoning/tool replay, models, usage/cost | [DeepSeek API backend](architecture/deepseek-api-backend.md) | Normative; initial `deepseek-v4-flash` profile live-qualified 2026-07-15 ([record](qualification/deepseek-2026-07-15.md)) |
...
| Phase order, status, and completion rules | [Implementation roadmap](implementation/README.md) | V1 `0.1.0` released; Phase 6C ready; Phase 6B qualifies integration |
| Direct dependency baseline and licenses | [Dependency baseline](implementation/dependencies.md) | Phase 0 evidence |
| Detailed V1 work | [Phase 0](implementation/v1/phase-0-foundation.md), [frozen Phase 1](implementation/v1/phase-1-chatgpt-codex-qualification.md), [Phase 1B](implementation/v1/phase-1b-deepseek-api-qualification.md), [Phase 2](implementation/v1/phase-2-headless-harness.md), [Phase 3](implementation/v1/phase-3-live-backend.md), optional [Phase 3B](implementation/v1/phase-3b-terminal-tui.md), [Phase 4](implementation/v1/phase-4-tools.md), [Phase 5](implementation/v1/phase-5-sessions.md), [Phase 6](implementation/v1/phase-6/README.md) | Phase-specific |
| Native completion, chat-first polish, compaction, subagents, second backend/portability | [V2 roadmap](implementation/v2/README.md) | Phase 6C ready; Phase 6B gates later expansion |
| Live external results | [Qualification records](qualification/README.md) | ChatGPT stopped; DeepSeek Phase 1B passed 2026-07-15; V1 native release evidence recorded 2026-07-17 |
| Upstream behavior | [Pi study](research/pi-source-study.md), [Codex study](research/codex-source-study.md), [`gpui-component` study](research/gpui-component-source-study.md), [Markdown/LaTeX study](research/markdown-latex-rendering.md), and [PTY/emulator study](research/terminal-pty-source-study.md) | Complete or gated at recorded revisions |
...
- **Workspace registration:** Preference-only sidebar identity for a canonical local directory; it is distinct from a session's durable `WorkspaceId` authority.
- **User terminal:** Direct user-operated local PTY, separate from the model-facing approved shell tool and never a model/approval channel.
...
- `gpui-component` source: `b004e595cf5de98a73b6b561394a559a94ae1e2a`
...
[V1 Phase 0](implementation/v1/phase-0-foundation.md) passed on 2026-07-14 with [recorded evidence](implementation/evidence/phase-0-2026-07-14.md). [ChatGPT Phase 1](implementation/v1/phase-1-chatgpt-codex-qualification.md) ended `STOP — FROZEN` on 2026-07-14 without a live request. [V1 Phase 1B](implementation/v1/phase-1b-deepseek-api-qualification.md) passed on 2026-07-15 with [live model, usage, tool-replay, cancellation, credential-lifecycle, and command evidence](qualification/deepseek-2026-07-15.md). [Phase 2](implementation/v1/phase-2-headless-harness.md) passed on 2026-07-15 with [deterministic headless evidence](implementation/evidence/phase-2-2026-07-15.md). [Phase 3](implementation/v1/phase-3-live-backend.md) passed on 2026-07-15 with [live-loop, cancellation, denial, usage, and command evidence](implementation/evidence/phase-3-2026-07-15.md). Optional [Phase 3B](implementation/v1/phase-3b-terminal-tui.md) passed on 2026-07-15 with [scripted, command-process, PTY, supervised-live, and manual evidence](implementation/evidence/phase-3b-2026-07-15.md). [Phase 4](implementation/v1/phase-4-tools.md) passed on 2026-07-15 with [fixture, dependency, live-command, manual macOS, and post-gate instruction/context hardening evidence](implementation/evidence/phase-4-2026-07-15.md). [Phase 5](implementation/v1/phase-5-sessions.md) passed on 2026-07-17 with [durability, recovery, command-process, process-death, and supervised-live evidence](implementation/evidence/phase-5-2026-07-17.md). [Phase 6](implementation/v1/phase-6/README.md) released V1 `0.1.0` on 2026-07-17 under [ADR 0005](decisions/0005-release-v1-and-defer-phase-6b.md), with [dated native release evidence](implementation/evidence/phase-6-release-candidate-2026-07-17.md). [Phase 6C](implementation/v2/phase-6c-chat-first-ui-polish.md) is ready for bounded presentation implementation from that baseline. [Phase 6B](implementation/v2/phase-6b-native-completion.md) then qualifies the integrated surface and remains the gate before Phase 7 or broader expansion.
