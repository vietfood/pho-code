...
The source configures these preferences, a header-based CSP, exact renderer URL/origin comparison, and bounded runtime disposal. Security, navigation, permission, and shutdown behavior are covered by the desktop test lane.
