...
- **Agent-tool sandbox add-on:** owner-approved 2026-08-16; implementation not started. Product and plan live under [`features/sandbox`](./features/sandbox/README.md). No OS sandbox exists in source. Distinct from Phase F runtime extraction and from the urgent window-first track.
