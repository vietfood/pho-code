...
- **Plan / Agent and ask-user add-on:** owner-approved 2026-08-16; implementation not started. End-to-end Plan vs Agent, juicesharp-style ask-back, session todos in both modes, and Plan document. Product and plan live under [`features/plan-agent`](./features/plan-agent/README.md). No toggle, questionnaire card, todo tool, or Plan surface exists in source.
