# Subagent orchestration implementation logs

This directory holds dated evidence for the active
[subagent-orchestration add-on](../product.md). The product boundary lives in
...
| 2026-09-01 | [`2026-09-01-owner-correction-backend-ownership.md`](./2026-09-01-owner-correction-backend-ownership.md) | Owner correction applied; Pho/Pi-only orchestration; native external projection |
