...
Use the repository verification vocabulary and record only checks that ran. When sandbox work touches shared protocol, Electron, accepted architecture, permission settings, or Settings chrome, scan and cross-link related logs under `../../../version/*/logs/`, `../../../ui/logs/`, and `../../terminal/logs/`.
