...
const portableAliases = {
  ...
  "@pho-agent/host": path.resolve(workspaceRoot, "packages/pho-agent/packages/host/src/index.ts"),
  "@pho-agent/backend-acp": path.resolve(workspaceRoot, "packages/pho-agent/packages/backend-acp/src/index.ts"),
  "@pho-agent/backend-codex": path.resolve(workspaceRoot, "packages/pho-agent/packages/backend-codex/src/index.ts"),
...
const bundledMainPackages = [
  ...
  "@pho-agent/runtime",
  "@pho-agent/host",
  "@pho-agent/backend-acp",
  "@pho-agent/backend-codex",
  "@pho-code/protocol",
